...
// for frac class default spaceship operrator doee not wotk becuase it has  two attributes.
// we se need to write custom spaceship oeprator overload.
// also we need to rtire == operator overload.
class frac {
    long n;
    long d;
