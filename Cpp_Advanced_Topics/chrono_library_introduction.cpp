...
seconds timer(const Callable auto& f) {
    using timer_clock = std::chrono::steady_clock; // tis is the best time for intervals
...
int main() {
    ...
    print("system_cloks::now is {:%F %T %Z}\n", t);
    newline();
    ...
    // both print sets below giving the same resault.

    // here we passing count of duration objects to to format-style print()
    ...
    // here we passing durectly the duration objects to format-style print()
