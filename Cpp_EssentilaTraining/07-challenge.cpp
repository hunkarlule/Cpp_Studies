...
public:
    ...
    // commented these becuase we are implement these as non-member function istead of member-fucntions.
...
int main() {
    ...
    // because we impelmented operators as non-member function both sets below is working.
